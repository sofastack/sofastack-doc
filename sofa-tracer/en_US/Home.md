...
### 2.1 Distributed link tracing solution based on OpenTracing specification
...
### 2.2 Provide asynchronous log printing to disks
...
### 2.3 Support automatic log cleanup and scrolling
...
### 2.4 Extended based on SLF4J MDC
