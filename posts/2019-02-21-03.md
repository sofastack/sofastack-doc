...
跨进程透传的方式有很多， 在这里以客户端向服务端发起 HTTP 请求的方式来演示跨进程传输， fork [代码](https://github.com/alipay/sofa-tracer)， 打开 sample/tracer-sample-with-httpclient 示例工程运行 HttpClientDemoApplication ，打开 logs/tracelog/spring-mvc-stat.log 即可看到链路日志， 运行结果 ：
...
> 关于异步线程处理的案例，可以参考 [SOFATracer 的测试用例](https://github.com/alipay/sofa-tracer/tree/master/tracer-core/src/test/java/com/alipay/common/tracer/core/async) 。
...
对应的 Demo 在 [tracer-samples/tracer-sample-with-slf4j ](https://github.com/alipay/sofa-tracer/tree/master/tracer-samples/tracer-sample-with-slf4j)下。
...
* SOFATracer 源码：[https://github.com/alipay/sofa-tracer](https://github.com/alipay/sofa-tracer)

* SOFAtrace的异步处理：[https://www.sofastack.tech/sofa-tracer/docs/Async](https://www.sofastack.tech/sofa-tracer/docs/Async)

* SOFATracer 的测试用例 :[https://github.com/alipay/sofa-tracer/tree/master/tracer-core/src/test/java/com/alipay/common/tracer/core/async](https://github.com/alipay/sofa-tracer/tree/master/tracer-core/src/test/java/com/alipay/common/tracer/core/async)

* SOFATracer 对 MDC 的扩展 demo ：[https://github.com/alipay/sofa-tracer/tree/master/tracer-samples/tracer-sample-with-slf4j](https://github.com/alipay/sofa-tracer/tree/master/tracer-samples/tracer-sample-with-slf4j)
